...
namespace Preparcial.Vista
{
    public partial class FrmMain : Form
    {
        ...
        private void bttnCreateUser_Click(object sender, EventArgs e)
        {
            ...
            //Corrección: Se agregó un mensaje que muestre error al agregar usuario
            else
        ...
        //Correción: Se cambiaron los operadores && por ||. Con && estaría cumpliéndose solo si todos fueran vacíos.
        ...
        {
            //Corrección: Se cambió el operador lógico a ||
        ...
        private void bttnMakeOrder_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //Corrección: Validación para comprobar que la cantidad de productos no sea mayor que el stock
        ...
        {
            //Correción: Se agregó validación de generalTab para mostrar mensaje de permisos solamente una vez
